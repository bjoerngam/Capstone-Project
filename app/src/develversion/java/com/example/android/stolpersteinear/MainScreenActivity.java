...
public class MainScreenActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Snackbar.make(findViewById(android.R.id.content),
                getResources().getString(R.string.snackbar_debug_version),
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_about_dialog:
                ...
                break;
            case R.id.action_location_information_screen:
                // Show the location information
                showPositionOverview();
                break;
            case R.id.action_gps_location_01:
                setGPSTestCoordinates(1);
                break;
            case R.id.action_gps_location_02:
                setGPSTestCoordinates(2);
                break;
            case R.id.action_gps_location_03:
    ...
    /**
     * Shows the current GPS position, the calculateTheoreticalAzimuth, calculateAzimuthAccuracy
     */
    ...
    public void setGPSTestCoordinates(int number) {
        switch (number) {
            case 1:
                // Victim: Josef Herzberger
                mLocationManager.removeUpdates(mLocationListener);
                setLatitude(50.9483204);
